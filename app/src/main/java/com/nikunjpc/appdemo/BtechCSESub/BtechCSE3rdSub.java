...
public class BtechCSE3rdSub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btech_cse3rd_sub);
        ...
        Subject1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(BtechCSE3rdSub.this, ClgActivity.class);
