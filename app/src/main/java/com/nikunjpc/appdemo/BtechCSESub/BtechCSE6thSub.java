...
public class BtechCSE6thSub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btech_cse6th_sub);
        ...
        Subject1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(BtechCSE6thSub.this, ClgActivity.class);
