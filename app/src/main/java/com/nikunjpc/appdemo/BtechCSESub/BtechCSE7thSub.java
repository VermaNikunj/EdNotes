...
public class BtechCSE7thSub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btech_cse7th_sub);
        ...
        Subject1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(BtechCSE7thSub.this, ClgActivity.class);
