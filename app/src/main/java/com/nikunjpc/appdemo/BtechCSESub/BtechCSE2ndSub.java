...
public class BtechCSE2ndSub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btech_cse2nd_sub);
        ...
        Subject1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(BtechCSE2ndSub.this, ClgActivity.class);
