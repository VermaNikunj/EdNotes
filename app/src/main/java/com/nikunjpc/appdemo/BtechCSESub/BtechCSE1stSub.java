...
import com.nikunjpc.appdemo.BtechCSE1stAcBook;
import com.nikunjpc.appdemo.ClgStart.ClgActivity;
import com.nikunjpc.appdemo.R;
//import androidx.appcompat.app.AppCompatActivity;
public class BtechCSE1stSub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btech_cse1st_sub);
        ...
        Subject1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(BtechCSE1stSub.this, BtechCSE1stAcBook.class);
        ...
        Subject2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(BtechCSE1stSub.this, ClgActivity.class);
                startActivity(intent);
            }
        });
